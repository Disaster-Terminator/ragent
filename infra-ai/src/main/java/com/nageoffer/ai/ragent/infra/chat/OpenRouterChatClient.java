...
@Slf4j
@Service
public class OpenRouterChatClient extends AbstractOpenAIStyleChatClient {

    public OpenRouterChatClient(OkHttpClient syncHttpClient,
    ...
    public String provider() {
        return ModelProvider.OPENROUTER.getId();
    }
